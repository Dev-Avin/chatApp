...
const LogOut = () => {
  return (
   <div className='flex item-center gap-2 justify-center hover:bg-slate-300 hover:bg-opacity-30  rounded-lg p-2 py-1 cursor-pointer'>
     <h1 className='text-white-500 font-8'> LogOut</h1>
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 471.2 471.2" xml:space="preserve"
